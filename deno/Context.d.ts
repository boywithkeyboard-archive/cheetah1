...
> = {
  ...
  req: {
     ...
     */
    cookies: ValidatedCookies extends ObjectSchema ? Static<ValidatedCookies>
      : ValidatedCookies

    /**
     * The validated headers of the incoming request.
     */
    headers: ValidatedHeaders extends ObjectSchema ? Static<ValidatedHeaders>
      : ValidatedHeaders
     ...
     */
    query: ValidatedQuery extends ObjectSchema ? Static<ValidatedQuery>
      : ValidatedQuery
