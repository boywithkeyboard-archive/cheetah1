...
```ts
import cheetah, { Collection } from 'https://deno.land/x/cheetah@v0.4.1/mod.ts'
...
```ts
// typebox
import typebox from 'https://deno.land/x/cheetah@v0.4.1/validator/typebox.ts'

const collection = new Collection<typeof typebox>()

// zod
import zod from 'https://deno.land/x/cheetah@v0.4.1/validator/zod.ts'
